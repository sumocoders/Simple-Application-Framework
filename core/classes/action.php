...
class SiteAction
{
    ...
    public function execute()
    {
        ...
        if (!SpoonFile::exists(
            PATH_WWW . '/modules/' . $this->getModule() . '/actions/' . $this->getAction() . '.php'
        )
        ) {
            // set headers
...
class SiteBaseAction
{
    ...
    public function display($template = null)
    {
        ...
        if ($template === null) {
            $template = PATH_WWW . '/modules/' . $this->url->getModule() . '/layout/templates/' . $this->url->getAction(
                ) . '.tpl';
        }

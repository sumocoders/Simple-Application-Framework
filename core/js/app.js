...
(function() {
  ...
  SpecificTheme = (function(_super) {
    ...
    function SpecificTheme() {
      this.toggleSubNavigation = __bind(this.toggleSubNavigation, this);      _ref1 = SpecificTheme.__super__.constructor.apply(this, arguments);
      return _ref1;
    }
    ...
    SpecificTheme.prototype.toggleSubNavigation = function(e) {
      var $subNav, $this;
